...
|[sctp-as-o-1-9-1](sctp-as-o-1-9-1.pkt   "Handling of INIT chunks with known addresses in the ESTABLISHED state")                            | Yes          | Yes       | No          | Passed (Note 9)| Passed          |
|[sctp-as-o-1-9-2](sctp-as-o-1-9-2.pkt   "Handling of INIT chunks with new addresses in the ESTABLISHED state")                              | Yes          | Yes       | No          | Passed (Note 9)| Passed          |
